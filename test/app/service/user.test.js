...
describe('test/app/service/user.test.js', () => {
      ...
      await ctx.model.User.bulkCreate([
        {
          ...
          name: 'yuqi03',
          age: 16,
          created_at: '2018-06-05T06:40:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 4,
          name: 'yuqi04',
          age: 15,
          created_at: '2018-06-05T06:41:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 5,
          name: 'yuqi05',
          age: 14,
          created_at: '2018-06-05T06:42:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 6,
          name: 'yuqi06',
          age: 13,
          created_at: '2018-06-05T06:43:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 7,
          name: 'yuqi07',
          age: 12,
          created_at: '2018-06-05T06:44:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 8,
          name: 'yuqi08',
          age: 11,
          created_at: '2018-06-05T06:45:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 9,
          name: 'yuqi09',
          age: 10,
          created_at: '2018-06-05T06:46:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 10,
          name: 'yuqi10',
          age: 9,
          created_at: '2018-06-05T06:47:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 11,
          name: 'yuqi11',
          age: 8,
          created_at: '2018-06-05T06:48:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        }, {
          id: 12,
          name: 'yuqi12',
          age: 7,
          created_at: '2018-06-05T06:49:16.498Z',
          updated_at: '2018-06-05T06:38:16.498Z',
        },
      ]);
    });
  ...
  describe('find(id)', () => {
    ...
    it('should find success', async function() {
      ...
      assert(user.age === 18);
      // assert(user.created_at.valueOf() === new Date('2018-06-05T06:38:16.498Z').valueOf());
      // assert(user.updated_at.valueOf() === new Date('2018-06-05T06:38:16.498Z').valueOf());
    });
    // 断言 -- 404
